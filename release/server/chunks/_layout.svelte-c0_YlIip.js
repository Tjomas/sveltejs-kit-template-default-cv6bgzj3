import { b as attr, i as resolve_route, j as initial_base, d as base } from './routing-ClX58tud.js';
import { L as try_get_request_store } from './context-C66aeybg.js';
...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<header class="svelte-vny38x"><div class="corner svelte-vny38x"><a href="https://svelte.dev/docs/kit" class="svelte-vny38x"><img${attr("src", logo)} alt="SvelteKit" class="svelte-vny38x"/></a></div> <nav class="svelte-vny38x"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-vny38x"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-vny38x"></path></svg> <ul class="svelte-vny38x"><li${attr("aria-current", page.url.pathname === "/" ? "page" : void 0)} class="svelte-vny38x"><a${attr("href", resolve("/"))} class="svelte-vny38x">Home</a></li> <li${attr("aria-current", page.url.pathname === "/about" ? "page" : void 0)} class="svelte-vny38x"><a${attr("href", resolve("/about"))} class="svelte-vny38x">About</a></li></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-vny38x"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-vny38x"></path></svg></nav> <div class="corner svelte-vny38x"><a href="https://github.com/sveltejs/kit" class="svelte-vny38x"><img${attr("src", github)} alt="GitHub" class="svelte-vny38x"/></a></div></header>`);
  });
}
function _layout($$renderer, $$props) {
  ...
  children($$renderer);
  $$renderer.push(`<!----></main> <footer class="svelte-12qhfyh"><p>visit <a href="https://svelte.dev/docs/kit" class="svelte-12qhfyh">svelte.dev/docs/kit</a> to learn about SvelteKit</p></footer></div>`);
}

export { _layout as default };
//# sourceMappingURL=_layout.svelte-c0_YlIip.js.map
