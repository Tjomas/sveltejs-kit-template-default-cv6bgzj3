import { t as text_decoder, s as set_ssr_context, a as ssr_context, p as push$1, b as pop$1, c as safe_equals, o as object_prototype, d as array_prototype, g as get_descriptor, i as is_extensible, e as equals, f as get_prototype_of, h as is_array, j as deferred, r as run_all, k as index_of, l as define_property, m as array_from, n as setContext, q as base64_decode, u as decode_pathname, v as decode_params, w as normalize_path, x as disable_search, y as with_request_store, z as validate_layout_server_exports, A as validate_layout_exports, B as validate_page_server_exports, C as validate_page_exports, D as text_encoder$2, E as resolve, F as make_trackable, G as get_relative_path, H as base64_encode$1, I as readable, J as writable } from './context-C66aeybg.js';
import { t as to_style, c as clsx, a as to_class, b as attr, d as base, e as app_dir, f as exec, g as assets, r as relative, o as override, h as reset } from './routing-ClX58tud.js';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./hooks.server-DLOvxUfc.js').then(function (n) { return n.n; }));
  let reroute;
  let transport;
  return {
    handle,
...
function encode(str) {
  const encoded = text_encoder$2.encode(str);
  ...
  return !chunks ? text(transformed, {
    ...
    new ReadableStream({
      async start(controller) {
        controller.enqueue(text_encoder$2.encode(transformed + "\n"));
        for await (const chunk of chunks) {
          if (chunk.length) controller.enqueue(text_encoder$2.encode(chunk));
        }
        controller.close();
      },
      type: "bytes"
...
async function render_data(event, event_state, route, options2, manifest, state, invalidated_data_nodes, trailing_slash) {
  ...
  try {
    ...
    return new Response(
      new ReadableStream({
        async start(controller) {
          controller.enqueue(text_encoder$2.encode(data));
          for await (const chunk of chunks) {
            controller.enqueue(text_encoder$2.encode(chunk));
          }
          controller.close();
        },
        type: "bytes"
...
export { Server as S, manifest as a, merge_tracing as m, read_implementation as r };
//# sourceMappingURL=index-BKZO3y0y.js.map
